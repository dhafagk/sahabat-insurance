...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "manajemen_highlights" ADD CONSTRAINT "manajemen_highlights_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."manajemen"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "manajemen_highlights_locales" ADD CONSTRAINT "manajemen_highlights_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."manajemen_highlights"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "manajemen_highlights_locales_locale_parent_id_unique" ON "manajemen_highlights_locales" USING btree ("_locale","_parent_id");
...
export async function down({
  ...
  DROP TABLE "manajemen_highlights" CASCADE;
  DROP TABLE "manajemen_highlights_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_manajemen_highlights_icon";
