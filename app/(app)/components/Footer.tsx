  ...
  upperColumns: [
    {
      title: "",
      content: [
        { blockType: "imageContent", image: { url: "/logo-white.png", alt: "Sahabat Insurance" }, href: "/", width: 180, height: 52 },
        { blockType: "textContent", content: "Berizin dan Diawasi\noleh Otoritas Jasa\nKeuangan" },
        { blockType: "badge", line1: "Pahami & Miliki", line2: "Asuransi", accentLine: "line2" },
      ],
    },
    {
      ...
      content: [
        {
          ...
          links: [
            ...
            { label: "Contractors' Plant and Machinery Insurance", href: "#products" },
      ...
      content: [
        {
          ...
          items: [
            { type: "phone", value: "tel:02150508080", displayText: "(021) 5050 8080" },
            { type: "address", value: "Jl. Danau Sunter Utara Blok B 36A Kav. 16-17 Sunter Jakarta 14350" },
            { type: "email", value: "mailto:contact@sahabatinsurance.id", displayText: "contact@sahabatinsurance.id" },
          ],
        },
      ],
    },
    {
      ...
      content: [
        ...
        {
          blockType: "contactInfo",
          items: [{ type: "phone", value: "tel:08531111010", displayText: "0853 1111 1010" }],
        },
      ],
    },
  ],
...
function BlockIcon({ name }: { name: IconName }) {
  const paths: Record<Exclude<IconName, "none">, string> = {
    ...
    plane: "M17.8 19.2 16 11l3.5-3.5C21 6 21 4 19.5 2.5S18 2 16.5 3.5L13 7 4.8 5.2 3.5 6.5l7 2-1 3-3 1-2-7L3 6.5l8.5 1.3",
    star: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z",
    check: "M20 6L9 17l-5-5",
    arrowRight: "M5 12h14M12 5l7 7-7 7",
    phone: "M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 01.07 1.18 2 2 0 012.03 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z",
    ...
    <ul className="flex flex-col gap-2">
      {block.links.map((link, i) => (
        <li key={link.id ?? i}>
          ...
          >
            {link.icon && link.icon !== "none" && <BlockIcon name={link.icon} />}
            {link.label}
          </a>
        </li>
      ))}
...
function RenderContactInfo({ block }: { block: ContactInfoBlock }) {
  return (
    <div className="flex flex-col gap-1">
      ...
      {block.companyName && (
        <p className="text-white text-sm font-medium mb-2">{block.companyName}</p>
      )}
...
function RenderImage({ block }: { block: ImageContentBlock }) {
  ...
  const alt =
    typeof block.image === "object" ? (block.image?.alt ?? "") : "";
  if (!src) return null;
      ...
      <div className="max-w-7xl mx-auto px-6 pt-14 pb-0">
        ...
        <div className="border-t border-slate-800 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {lower.links && lower.links.length > 0 && (
            <nav aria-label="Footer secondary navigation" className="flex items-center gap-1">
