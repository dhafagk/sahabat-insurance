...
const DEFAULTS = {
  heading: 'Protected by a friend you can trust',
  subtext: 'Hubungi kami sekarang untuk konsultasi gratis',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at 30% 40%, rgba(45,86,194,0.4) 0%, transparent 60%)',
            }}
            aria-hidden="true"
          />
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-2">
              ...
              <a
                ...
                aria-label={`WhatsApp us at ${whatsappUrl}`}
              >
                <WhatsAppIcon />
